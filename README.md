...
상세는 [`ultra_loop_guide.md`](templates/mydocs/manual/ultra_loop_guide.md), 자율 실행과 charter 경계 규율은 [`agent_autonomy_charter_discipline.md`](templates/mydocs/manual/agent_autonomy_charter_discipline.md)를 따릅니다.

...
- 내부 task PR은 GitHub Issue, `local/task{번호}`, charter, 구현계획서, 단계 보고서, 최종 보고서를 기준으로 처리한다.
...
- [`task_workflow_guide.md`](task_workflow_guide.md): 내부 task의 charter, 구현, 단계 보고, 최종 보고 흐름.
